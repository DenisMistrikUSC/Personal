...
class MergeSort{
  ...
  private static class SortThreads extends Thread{
      SortThreads(Player[] array, int begin, int end){
          super(()->{
  ...
  public static void threadedSort(Player[] array){
  ...
  public static void mergeSort(Player[] array, int begin, int end){
      if (begin<end){
          int mid = (begin+end)/2;
  ...
  //Typical 2-way merge
  public static void merge(Player[] array, int begin, int mid, int end){
      Player[] temp = new Player[(end-begin)+1];
